...
export function MissingInfo() {
  ...
  const handleSaveClick = () => {
    ...
    console.log('Saving question data:', questionsData); // Log the data being sent

    const apiUrl = `https://qzblapi.azurewebsites.net/api/EditQuestions?uid=${uid}&questions=${encodeURIComponent(JSON.stringify(questionsData))}`;
    ...
    fetch(apiUrl, { method: 'POST' })
      ...
      .then(data => {
        console.log("Questions edited:", data.questionsEdited); // Log the data returned
